        ...
        <>
            <ContainerInterface padding='4' justify="center" align="center" direction="column" height='100%'>
                <ParallaxEffect intensity={0.7} perspective={1200} tiltMax={45} deadzoneX={0.1} deadzoneY={0.245}>
                    <CardStylized isGrayTop sizeTextSmall="3" uppercase sizeText='4' weight='bold' contentTop="Premium features, Elegant & intuitive design, Instant Online Access" topSmallText="An optimised experience for simplified, efficient management." bottomTitle="hephai Premium" bottomDescription={<SmokeEffect text="coming soon" size='2' uppercase weight='medium' color='gray' />} />
                </ParallaxEffect>
