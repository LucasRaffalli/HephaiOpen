            ...
            <Tooltip content={t('utils.tooltips.payment.iban')}>
                <Box>
                    <TextField.Root
                        ...
                        placeholder={t('features.invoice.paymentMethods.ibanPlaceholder')}
                        size="2"
                        onClick={() => handleFieldSelect('iban')}
                        onChange={(e) => handleChange('iban', e.target.value)}
                        style={{ opacity: selectedField === 'iban' || selectedField === null ? 1 : 0.5 }}
                        className='btnCursor'
                    />
            ...
            <Tooltip content={t('utils.tooltips.payment.paypal')}>
                <Box>
                    <TextField.Root
                        ...
                        placeholder={t('features.invoice.paymentMethods.paypalPlaceholder')}
                        size="2"
                        onClick={() => handleFieldSelect('paypal')}
                        onChange={(e) => handleChange('paypal', e.target.value)}
                        style={{ opacity: selectedField === 'paypal' || selectedField === null ? 1 : 0.5 }}
                        className='btnCursor'
                    />
            ...
            <Tooltip content={t('utils.tooltips.payment.other')}>
                <Box>
                    <TextField.Root
                        ...
                        placeholder={t('features.invoice.paymentMethods.otherPlaceholder')}
                        size="2"
                        onClick={() => handleFieldSelect('other')}
                        onChange={(e) => handleChange('other', e.target.value)}
                        style={{ opacity: selectedField === 'other' || selectedField === null ? 1 : 0.5 }}
                        className='btnCursor'
                    />
                </Box>
            </Tooltip>
